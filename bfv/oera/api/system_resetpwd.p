...
{bfv/oera/service/dsresetpassword.i}
                    
define output       parameter DATASET for dsException.
define input-output parameter DATASET for dsResetPassword.
...
/*    servicemgr:getInstance():authenticationService:serverResetPassword(input-output dataset dsResetPassword by-reference,*/
/*        contextInstance).                                                                                                */
